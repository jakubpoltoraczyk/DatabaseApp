...
void CustomMessageDialogController::showMessageDialog(const QString& titleText,
...
const QString& CustomMessageDialogController::getContent() const { return content; }
